...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fusion.thenfile'
        db.add_column('fusion_fusion', 'thenfile', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Fusion.nowfile'
        db.add_column('fusion_fusion', 'nowfile', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fusion.thenfile'
        db.delete_column('fusion_fusion', 'thenfile')

        # Deleting field 'Fusion.nowfile'
        db.delete_column('fusion_fusion', 'nowfile')
    ...
    models = {
        ...
        'fusion.fusion': {
            ...
            'nowfile': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'thenfile': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
