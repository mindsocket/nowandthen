...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageType.infourl'
        db.alter_column('fusion_imagetype', 'infourl', self.gf('django.db.models.fields.URLField')(max_length=255))

        # Changing field 'ImageType.dataurl'
        db.alter_column('fusion_imagetype', 'dataurl', self.gf('django.db.models.fields.URLField')(max_length=255))

        # Changing field 'Image.infourl'
        db.alter_column('fusion_image', 'infourl', self.gf('django.db.models.fields.URLField')(max_length=255))

        # Changing field 'Image.thumburl'
        db.alter_column('fusion_image', 'thumburl', self.gf('django.db.models.fields.URLField')(max_length=255))

        # Changing field 'Image.imageurl'
        db.alter_column('fusion_image', 'imageurl', self.gf('django.db.models.fields.URLField')(unique=True, max_length=255))


    def backwards(self, orm):
        
        # Changing field 'ImageType.infourl'
        db.alter_column('fusion_imagetype', 'infourl', self.gf('django.db.models.fields.URLField')(max_length=256))

        # Changing field 'ImageType.dataurl'
        db.alter_column('fusion_imagetype', 'dataurl', self.gf('django.db.models.fields.URLField')(max_length=256))

        # Changing field 'Image.infourl'
        db.alter_column('fusion_image', 'infourl', self.gf('django.db.models.fields.URLField')(max_length=256))

        # Changing field 'Image.thumburl'
        db.alter_column('fusion_image', 'thumburl', self.gf('django.db.models.fields.URLField')(max_length=256))

        # Changing field 'Image.imageurl'
        db.alter_column('fusion_image', 'imageurl', self.gf('django.db.models.fields.URLField')(max_length=256, unique=True))
