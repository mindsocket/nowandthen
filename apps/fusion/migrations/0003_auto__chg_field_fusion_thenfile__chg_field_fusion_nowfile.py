...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fusion.thenfile'
        db.alter_column('fusion_fusion', 'thenfile', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='/usr/local/src/nowandthen/media/fusions', null=True))

        # Changing field 'Fusion.nowfile'
        db.alter_column('fusion_fusion', 'nowfile', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='/usr/local/src/nowandthen/media/fusions', null=True))


    def backwards(self, orm):
        
        # Changing field 'Fusion.thenfile'
        db.alter_column('fusion_fusion', 'thenfile', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True))

        # Changing field 'Fusion.nowfile'
        db.alter_column('fusion_fusion', 'nowfile', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True))
