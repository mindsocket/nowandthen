...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.latitude'
        db.add_column('fusion_image', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Image.longitude'
        db.add_column('fusion_image', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.latitude'
        db.delete_column('fusion_image', 'latitude')

        # Deleting field 'Image.longitude'
        db.delete_column('fusion_image', 'longitude')
